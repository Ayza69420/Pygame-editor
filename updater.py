...
version = requests.get("https://raw.githubusercontent.com/Ayza69420/Pygame-editor/version.txt").text # Repo version
...
def update():
    for repo_file in repo_files["tree"]:
        if repo_file["mode"] == 100644:
            ...
            content = requests.get(f"https://raw.githubusercontent.com/Ayza69420/Pygame-editor/{file_path}").text
            
            if file_path == "main/settings.json": # This is to not mess up the user's current set settings, just adds the new settings.
                with open(path+file_path, "r+") as f:
                    settings = json.loads(requests.get(f"https://raw.githubusercontent.com/Ayza69420/Pygame-editor/main/settings.json").text)
